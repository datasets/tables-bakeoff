...
export const meta = {
  ...
  notes:
    ...
    "Inputs.table exposes nothing for this itself. There is no column " +
    "windowing either — @observablehq/inputs has no option for it and builds " +
    "a <td> for every column of every row it appends (src/table.js line 100), " +
    "so on the 80-column `wide` card all 80 columns are live in each row where " +
    "the grids here render only the dozen on screen. That said it is the " +
